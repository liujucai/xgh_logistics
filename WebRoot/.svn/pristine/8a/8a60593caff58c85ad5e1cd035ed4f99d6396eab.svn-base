		                        ...
		                        <ul class="nav nav-second-level">
		                        		<c:forEach items="${permissions }" var="p2">
		                        			<c:if test="${p2.pid == p.menu_id}">
		                        				<li>
					                                <a class="J_menuItem" href="${p2.url}?menuCode=${p2.menu_code}" code="${p2.menu_code }" >${p2.menu_name }</a>
					                            </li>
		                        			</c:if>
		                        		</c:forEach>
		                        </ul>
...
<!--                         <li class="hidden-xs"> -->
<!--                             <a href="index.jsp" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a> -->
<!--                         </li> -->
            ...
            <div class="footer">
                <div class="pull-middle">&copy; 2014-2015 <a href="#" target="_blank">zihan's blog</a>
<!--                 <div class="pull-right">&copy; 2014-2015 <a href="#" target="_blank">zihan's blog</a> -->
        ...
        <div class="small-chat-box fadeInRight animated" >
            ...
            <div class="content" id="notify_msg">
                <div class="left">
                    <div class="author-name">
                       	通知 <small class="chat-date">  08:45 </small>
                    </div>
                    <div class="chat-message">
                         <br/>1.所有源码(未压缩、带注释版本)；2.说明文档；
                         <br/><a class="J_menuItem" href="role/list.cs">消息处理</a>
                    </div>
                </div>
