 ...
 * @ClassName: ScaleImageUtils 
 * @Description: TODO
 * @author: cosco gt.fan@msn.cn
 * @date: 2016年8月19日 下午11:51:49
 */
public abstract class ScaleImageUtil{
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        ...
        System.out.println(ScaleImageUtil.resize(200, 200, null, new File("d://1490334211082.png")));
//        System.out.println(ScaleImageUtil.resize(140, 140, null, new URL("http://picm.photophoto.cn/005/008/007/0080071495.jpg")));
//        ScaleImageUtil.resize(100, 100, ImageQuality.high.getQuality(), null, ImageIO.read(new URL("http://www.open-open.com/lib/images/logo.jpg")));
    }
}